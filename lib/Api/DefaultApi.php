...
class DefaultApi
{
     ...
     * @param  string $x_api_key Jedinečný bezpečnostní klíč eshopu. [Online dokumentace je dostupná zde](https://benefit-kelnero.atlassian.net/wiki/spaces/NPBBP/pages/1448902683/Platebn+br+na+pro+e-shopy+v2+-+HTTP+hlavi+ky+a+URL+parametry#X-API-Key) (required)
     * @param  string $eshop_guid Jedinečný GUID eshopu. [Online dokumentace je dostupná zde](https://benefit-kelnero.atlassian.net/wiki/spaces/NPBBP/pages/1448902683/Platebn+br+na+pro+e-shopy+v2+-+HTTP+hlavi+ky+a+URL+parametry#{eshopGUID}) (required)
     * @param  string $accept_language Jedinečný bezpečnostní klíč eshopu. [Online dokumentace je dostupná zde](https://benefit-kelnero.atlassian.net/wiki/spaces/NPBBP/pages/1448902683/Platebn+br+na+pro+e-shopy+v2+-+HTTP+hlavi+ky+a+URL+parametry#X-API-Key) (optional)
     *
     * @throws \BenefitPlus\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \BenefitPlus\Model\PGv2EshopOrderResult
     */
    public function eshopsEshopGUIDEshopordersPost($body, $x_api_key, $eshop_guid, $accept_language = null)
    {
        list($response) = $this->eshopsEshopGUIDEshopordersPostWithHttpInfo($body, $x_api_key, $eshop_guid, $accept_language);
        return $response;
    }
     ...
     */
    public function eshopsEshopGUIDEshopordersPostWithHttpInfo($body, $x_api_key, $eshop_guid, $accept_language = null)
    {
        $returnType = '\BenefitPlus\Model\PGv2EshopOrderResult';
        $request = $this->eshopsEshopGUIDEshopordersPostRequest($body, $x_api_key, $eshop_guid, $accept_language);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eshopsEshopGUIDEshopordersPostAsync($body, $x_api_key, $eshop_guid, $accept_language = null)
    {
        return $this->eshopsEshopGUIDEshopordersPostAsyncWithHttpInfo($body, $x_api_key, $eshop_guid, $accept_language)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function eshopsEshopGUIDEshopordersPostAsyncWithHttpInfo($body, $x_api_key, $eshop_guid, $accept_language = null)
    {
        $returnType = '\BenefitPlus\Model\PGv2EshopOrderResult';
        $request = $this->eshopsEshopGUIDEshopordersPostRequest($body, $x_api_key, $eshop_guid, $accept_language);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function eshopsEshopGUIDEshopordersPostRequest($body, $x_api_key, $eshop_guid, $accept_language = null)
    {
